# SendGrid emailing for RedWireless

A SendGrid extension for RedWireless. This extension is used to send email to customers.
...
```json
{
  "reset_password_url": "https://demo.redwireless.ca/reset-password?token=3NedZnEvEMCuLU1x1IHT684B"
}
```
